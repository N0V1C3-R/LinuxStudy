...
+ 1.2 具体的目录结构
  ...
  >+ **/home** 【常用】<br>
  存放普通用户的主目录，在Linux中每一个用户都有自己的一个目录，一般该目录名是以用户的账号命名
  >+ **/root** 【常用】<br>
  ...
  >+ **/boot** 【常用】<br>
  存放的是启动Linux时使用的一些核心文件，包括一些链接文件及镜像文件
  >+ **/proc** <br>
...
+ 2.1 vi和vim是什么？
  >+ vi时Linux系统内置的编辑器
  >+ vim具有程序编辑能力，可以看作是vi的增强版，可以主动的以字体颜色辨别语法的正确性，方便程序设计。代码补全、编译及错误跳转等方便编写的功能丰富，被广泛使用
+ 2.2 vi和vim常用的三种模式
  >+ **正常模式**<br>
